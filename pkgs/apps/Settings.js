...
export default {
  ...
  strings: {
    ...
    ja_JP: {
      ...
      webBrowser: "ウェブブラウザ",
      deviceType: "デバイスの種類",
      webProtocol: "Webプロトコル",
      webHost: "Webホスト",
      plutoInfo: "Plutoについて",
      storageUsed: "ストレージ使用量",
      coreVersion: "コアバージョン",
      supportedVersions: "対応バージョン",
      errorCouldNotFetch: "アカウントサービスから情報を取得できませんでした",
      loginWithZeon: "Zeonアカウントでログイン",
      logOut: "ログアウト",
      zeonAccount: "Zeonアカウント",
      changeWallpaper: "壁紙を変更",
      imageLoadError: "画像ファイルではないようです",
      wantsLoginScreen: "未ログイン時にログイン画面を表示する",
      useThemeWallpaper: "テーマの壁紙を使用する",
      toolbarPosition: "ツールバーの位置",
      toolbarPositionVertical: "縦",
      toolbarPositionHorizontal: "横",
      dockStyle: "ドックスタイル",
      dockStyleFull: "フル",
      dockStyleCompact: "コンパクト",
      dockStyleMinimal: "ミニマル",
      dockShowTray: "ドックにアプリトレイを表示する",
      dockShowAssistant: "ドックにアシスタントを表示する",
      testNetwork: "ネットワークをテスト",
      networkTestSuccess: "オンラインです。問題ありません！",
      networkTestResult: "インターネット接続の状態: {status}",
      networkTestMs: "平均応答時間: {responseTime}ms",
      networkTestError:
        "ネットワークが正常に動作していません。ステータスコード: {req1Status}, {req2Status}",
      noInstalledApps: "ローカルアプリケーションはありません。",
      securityCheck: "セキュリティチェック",
      securityCheckEveryStartup: "起動時に毎回チェックする",
      securityTableItemName: "名前",
      securityTableItemSafe: "安全",
      securityTableItemDelete: "アプリを削除",
      localApps: "ローカルアプリケーション",
      knownPackageList: "ロード済みパッケージ",
      appStoreOpenToSeeApps:
        "インストール済みアプリを確認するにはApp Storeを開いてください",
    },
  },
